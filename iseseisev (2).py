            ...
            for vastane in vastased: # kontrollib kõiki vastaseid listis
                ...
                if (
                    ...
                    # tabamus.wav saab 1 sekundi delay
                     ...
                     #kutsub reset_tabamus funktiooni 1 sekundi pärast, mis muudab tabamus_valmis true-ks
                    

        root.after(100, puutetuvastus)

    root.after(100, puutetuvastus)  # kontrollib iga natukese aja tagant kas objektide ääred puutuvad
